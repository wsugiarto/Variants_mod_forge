...
public class CopperStaffBoltRenderer extends EntityRenderer<CopperStaffBolt>{
    // Copies from Llama Spit Renderer

   private static final ResourceLocation COPPER_STAFF_BOLT_LOCATION = new ResourceLocation(VariantsMod.MODID, "textures/entity/copper_staff_bolt.png");
   private final LlamaSpitModel<CopperStaffBolt> model;

   public CopperStaffBoltRenderer(EntityRendererProvider.Context p_174296_) {
      super(p_174296_);
      this.model = new LlamaSpitModel<>(p_174296_.bakeLayer(ModelLayers.LLAMA_SPIT));
   }

   public void render(CopperStaffBolt p_115373_, float p_115374_, float p_115375_, PoseStack p_115376_, MultiBufferSource p_115377_, int p_115378_) {
      p_115376_.pushPose();
      ...
      VertexConsumer vertexconsumer = p_115377_.getBuffer(this.model.renderType(COPPER_STAFF_BOLT_LOCATION));
   ...
   public ResourceLocation getTextureLocation(CopperStaffBolt p_115371_) {
      return COPPER_STAFF_BOLT_LOCATION;
   }
