...
public class NetheriteForkProjectileRenderer extends EntityRenderer<NetheriteForkProjectile>{
   // copied from Wither Skull Renderer
   
   private static final ResourceLocation NETHERITE_SKULL_LOCATION = new ResourceLocation(VariantsMod.MODID, "textures/entity/netherite_magic.png");
   private final SkullModel model;

   public NetheriteForkProjectileRenderer(EntityRendererProvider.Context p_174449_) {
      super(p_174449_);
   ...
   public void render(NetheriteForkProjectile p_116484_, float p_116485_, float p_116486_, PoseStack p_116487_, MultiBufferSource p_116488_, int p_116489_) {
      p_116487_.pushPose();
   ...
   public ResourceLocation getTextureLocation(NetheriteForkProjectile p_116482_) {
