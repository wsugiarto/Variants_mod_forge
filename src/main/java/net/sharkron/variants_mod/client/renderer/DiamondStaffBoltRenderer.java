...
public class DiamondStaffBoltRenderer extends EntityRenderer<DiamondStaffBolt>{
   ...
   private final LlamaSpitModel<DiamondStaffBolt> model;

   public DiamondStaffBoltRenderer(EntityRendererProvider.Context p_174296_) {
      super(p_174296_);
      this.model = new LlamaSpitModel<>(p_174296_.bakeLayer(ModelLayers.LLAMA_SPIT));
   }

   public void render(DiamondStaffBolt p_115373_, float p_115374_, float p_115375_, PoseStack p_115376_, MultiBufferSource p_115377_, int p_115378_) {
      p_115376_.pushPose();
   ...
   public ResourceLocation getTextureLocation(DiamondStaffBolt p_115371_) {
