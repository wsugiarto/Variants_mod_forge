...
public class TopazSpellbookBoltRenderer extends EntityRenderer<TopazSpellbookMainBolt>{
    // Copies from Llama Spit Renderer

   private static final ResourceLocation TEXTURE_LOCATION = new ResourceLocation(VariantsMod.MODID, "textures/entity/topaz_staff_bolt.png");
   private final LlamaSpitModel<TopazSpellbookMainBolt> model;

   public TopazSpellbookBoltRenderer(EntityRendererProvider.Context p_174296_) {
      super(p_174296_);
      this.model = new LlamaSpitModel<>(p_174296_.bakeLayer(ModelLayers.LLAMA_SPIT));
   }

   public void render(TopazSpellbookMainBolt p_115373_, float p_115374_, float p_115375_, PoseStack p_115376_, MultiBufferSource p_115377_, int p_115378_) {
      p_115376_.pushPose();
   ...
   public ResourceLocation getTextureLocation(TopazSpellbookMainBolt p_115371_) {
