...
public class VexxProjectileRenderer extends EntityRenderer<VexxProjectile>{
    // Copies from Llama Spit Renderer

   private static final ResourceLocation VEXX_PROJECTILE_LOCATION = new ResourceLocation(VariantsMod.MODID, "textures/entity/vexx_projectile.png");
   private final LlamaSpitModel<VexxProjectile> model;

   public VexxProjectileRenderer(EntityRendererProvider.Context p_174296_) {
      super(p_174296_);
      this.model = new LlamaSpitModel<>(p_174296_.bakeLayer(ModelLayers.LLAMA_SPIT));
   }

   public void render(VexxProjectile p_115373_, float p_115374_, float p_115375_, PoseStack p_115376_, MultiBufferSource p_115377_, int p_115378_) {
      p_115376_.pushPose();
      ...
      VertexConsumer vertexconsumer = p_115377_.getBuffer(this.model.renderType(VEXX_PROJECTILE_LOCATION));
   ...
   public ResourceLocation getTextureLocation(VexxProjectile p_115371_) {
      return VEXX_PROJECTILE_LOCATION;
   }
