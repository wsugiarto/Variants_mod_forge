...
public class AmethystShardBoltRenderer extends EntityRenderer<AmethystShardBolt>{
    // Copies from Llama Spit Renderer

   private static final ResourceLocation AMETHYST_SHARD_BOLT_LOCATION = new ResourceLocation(VariantsMod.MODID, "textures/entity/amethyst_shard_bolt.png");
   private final LlamaSpitModel<AmethystShardBolt> model;

   public AmethystShardBoltRenderer(EntityRendererProvider.Context p_174296_) {
      super(p_174296_);
      this.model = new LlamaSpitModel<>(p_174296_.bakeLayer(ModelLayers.LLAMA_SPIT));
   }

   public void render(AmethystShardBolt p_115373_, float p_115374_, float p_115375_, PoseStack p_115376_, MultiBufferSource p_115377_, int p_115378_) {
      p_115376_.pushPose();
      ...
      VertexConsumer vertexconsumer = p_115377_.getBuffer(this.model.renderType(AMETHYST_SHARD_BOLT_LOCATION));
   ...
   public ResourceLocation getTextureLocation(AmethystShardBolt p_115371_) {
      return AMETHYST_SHARD_BOLT_LOCATION;
   }
