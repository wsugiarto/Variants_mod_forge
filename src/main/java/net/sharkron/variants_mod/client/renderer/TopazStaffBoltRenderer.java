...
public class TopazStaffBoltRenderer extends EntityRenderer<TopazStaffBolt>{
    // Copies from Llama Spit Renderer

   private static final ResourceLocation TOPAZ_STAFF_BOLT_LOCATION = new ResourceLocation(VariantsMod.MODID, "textures/entity/topaz_staff_bolt.png");
   private final LlamaSpitModel<TopazStaffBolt> model;

   public TopazStaffBoltRenderer(EntityRendererProvider.Context p_174296_) {
      super(p_174296_);
      this.model = new LlamaSpitModel<>(p_174296_.bakeLayer(ModelLayers.LLAMA_SPIT));
   }

   public void render(TopazStaffBolt p_115373_, float p_115374_, float p_115375_, PoseStack p_115376_, MultiBufferSource p_115377_, int p_115378_) {
      p_115376_.pushPose();
      ...
      VertexConsumer vertexconsumer = p_115377_.getBuffer(this.model.renderType(TOPAZ_STAFF_BOLT_LOCATION));
   ...
   public ResourceLocation getTextureLocation(TopazStaffBolt p_115371_) {
      return TOPAZ_STAFF_BOLT_LOCATION;
   }
