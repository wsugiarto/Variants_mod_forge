...
public class RedstoneSpellbookProjectile extends AbstractStaffBolt{
    private int life;

    public RedstoneSpellbookProjectile(EntityType<? extends RedstoneSpellbookProjectile> p, Level level){
        super(p, level);
    }

    // This should be constructor for non abstract
    public RedstoneSpellbookProjectile(Level level, LivingEntity owner, double x, double y, double z){
        this(ModEntity.REDSTONE_SPELLBOOK_PROJECTILE.get(), level);
        this.setOwner(owner);
    ...
    protected void onHitEntity(EntityHitResult hit) {
        ...
        if (entity instanceof LivingEntity livingentity) {
            ...
            if(hit_entity instanceof LivingEntity){
                ...
                MobEffectInstance mobeffectinstance = new MobEffectInstance(MobEffects.MOVEMENT_SLOWDOWN, 15, 10);
