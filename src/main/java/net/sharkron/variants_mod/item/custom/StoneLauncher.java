...
public class StoneLauncher extends Item{
    public StoneLauncher(Properties pProperties){
        super(pProperties);
    }
    ...
    public InteractionResultHolder<ItemStack> use(Level level, Player player, InteractionHand hand) {
        ...
        if (level.isClientSide || !hasAmmo(player)) {
            ...
            StoneLauncherProjectile proj1 = new StoneLauncherProjectile(level, player, look.x, look.y, look.z);
