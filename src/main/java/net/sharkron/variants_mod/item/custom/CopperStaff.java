...
public class CopperStaff extends Item{
    public CopperStaff(Properties pProperties){
        super(pProperties);
    }
    ...
    public InteractionResultHolder<ItemStack> use(Level level, Player player, InteractionHand hand) {
        ...
        if (level.isClientSide || itemstack.getDamageValue() >= maxUseBeforeBroken) {
            ...
            CopperStaffBolt proj1 = new CopperStaffBolt(level, player, look.x, look.y, look.z);
