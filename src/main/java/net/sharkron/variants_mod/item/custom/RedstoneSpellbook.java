...
public class RedstoneSpellbook extends Item{
    public RedstoneSpellbook(Properties pProperties){
        super(pProperties);
    }
    ...
    public InteractionResultHolder<ItemStack> use(Level level, Player player, InteractionHand hand) {
        ...
        if (level.isClientSide || itemstack.getDamageValue() >= maxUseBeforeBroken) {
            ...
            RedstoneSpellbookProjectile proj1 = new RedstoneSpellbookProjectile(level, player, look.x, look.y, look.z);
    ...
    public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, TooltipFlag pIsAdvanced) {
        pTooltipComponents.add(Component.literal("Consumes 50 Mana"));
